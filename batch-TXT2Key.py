...
def process_file(txt_path, output_directory):
    # Read text from file
    ...
    # Exclude the first word in the filename from keywords
    ...
    word_counts_dir = os.path.join(output_directory, 'WordCounts')
